package com.android.app.employeedatabase73;
...
public class MainActivity extends AppCompatActivity {
    ...
    Boolean saveImageInDB() {
        ...
        employee.setEmployeeName("SHRUTISANTOSH");
        employee.setEmployeeAge("25");
        employee.setEmployeeSex("FEMALE");

        Bitmap bitmapImage = BitmapFactory.decodeResource(getResources(),R.drawable.user);
